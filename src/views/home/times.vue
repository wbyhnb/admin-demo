...
class ProgressClock {
	...
	getMonthInfo(mo,yr) {
		switch (mo) {
			case 1:
				return { name: "一月", days: yr % 4 === 0 ? 29 : 28 };
			case 2:
				return { name: "二月", days: 31 };
			case 3:
				return { name: "三月", days: 30 };
			case 4:
				return { name: "四月", days: 31 };
			case 5:
				return { name: "五月", days: 30 };
			case 6:
				return { name: "六月", days: 31 };
			case 7:
				return { name: "七月", days: 31 };
			case 8:
				return { name: "八月", days: 30 };
			case 9:
				return { name: "九月", days: 31 };
			case 10:
				return { name: "十月", days: 30 };
			case 11:
				return { name: "十一月", days: 31 };
			default:
